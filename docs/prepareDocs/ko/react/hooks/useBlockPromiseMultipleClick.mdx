...
[useDebounce](https://team-grace.github.io/devgrace/ko/docs/react/hooks/useDebounce/)를 사용해 중복 호출을 방지할 수는 있지만, 시간 값에 의존하기 때문에 만약 `Promise`가 이행될 때까지 호출을 완벽하게 차단해야 한다면 부족합니다.
