...
<div style={{ maxWidth: '500px', height: '500px', overflow:'scroll', background: '#f8f8f8' }}>
  <div style={{ width: '100%', height: '500px',  textAlign: 'center', fontSize: '2rem' }}>
   ...
   <LazyImage
    fallback={<div style={{ width: '100%', height: '400px', background: '#E79E90'}}>Skeleton1</div>}
    width={"100%"}
    height={400}
    duration={300}
    src={
  ...
  <div style={{ display: 'flex', gap: '8px'}}>
    <LazyImage
      fallback={<div style={{ width: '100%', height: '250px', background: '#8a5ace'}}>Skeleton2</div>}
      width={"100%"}
      height={250}
      duration={300}
      src={
    ...
    />
    <LazyImage
      fallback={<div style={{ width: '100%', height: '250px', background: '#3cbce7'}}>Skeleton3</div>}
      width={"100%"}
      height={250}
      duration={300}
      src={
  ...
  <LazyImage
    fallback={<div style={{ width: '100%', height: '400px', background: '#E79E90'}}>Skeleton4</div>}
    width={"100%"}
    height={400}
    duration={300}
    src={
